...
Le composant Bandeau d'information importante comporte une icone par defaut qui peut être personnalisée avec l'utilisation d'une classe utilitaire d'icône `fr-icon--NOM-ICONE` (voir Icônes) sur le conteneur du titre du bandeau.
...
### Exemple de bandeau d'avertissement
...
### Exemple de Vigilance météo orange
...
### Exemple de Vigilance météo rouge
...
### Exemple de Vigilance météo violette
...
### Exemple de Alerte technologique (Cyber-attaque)
