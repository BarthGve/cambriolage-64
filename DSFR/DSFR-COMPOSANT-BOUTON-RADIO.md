...
```html
<fieldset class="fr-fieldset" role="group" aria-labelledby="radio-legend radio-messages">
...
<fieldset class="fr-fieldset fr-fieldset--valid" role="group" aria-labelledby="radio-legend radio-messages">
    ...
    <div class="fr-messages-group" id="radio-messages" aria-live="polite">
        <p class="fr-message fr-message--valid" id="radio-message-valid">Texte de succès</p>
    </div>
</fieldset>
```
