...
- Des valeurs en fonction du type de données. Voir l'ensemble des valeurs disponibles.
...
- `password` : Champ de saisie de mot de passe (privilégier l'utilisation du composant mot de passe)
