...
```html
<dialog id="fr-theme-modal" aria-labelledby="fr-theme-modal-title" role="dialog" class="fr-modal">
                                        ...
                                        <div class="fr-radio-group fr-radio-rich">
                                            ...
                                            <div class="fr-radio-rich__img">
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                                                    <use class="fr-artwork-decorative" href="../../../dist/artwork/light/system/light.svg#artwork-decorative"></use>
                                                    <use class="fr-artwork-minor" href="../../../dist/artwork/light/system/light.svg#artwork-minor"></use>
                                                    <use class="fr-artwork-major" href="../../../dist/artwork/light/system/light.svg#artwork-major"></use>
                                                </svg>
                                            </div>
                                        </div>
                                        <div class="fr-radio-group fr-radio-rich">
                                            ...
                                            <div class="fr-radio-rich__img">
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                                                    <use class="fr-artwork-decorative" href="../../../dist/artwork/light/system/dark.svg#artwork-decorative"></use>
                                                    <use class="fr-artwork-minor" href="../../../dist/artwork/light/system/dark.svg#artwork-minor"></use>
                                                    <use class="fr-artwork-major" href="../../../dist/artwork/light/system/dark.svg#artwork-major"></use>
                                                </svg>
                                            </div>
                                        </div>
                                        <div class="fr-radio-group fr-radio-rich">
                                            ...
                                            <div class="fr-radio-rich__img">
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                                                    <use class="fr-artwork-decorative" href="../../../dist/artwork/light/system/system.svg#artwork-decorative"></use>
                                                    <use class="fr-artwork-minor" href="../../../dist/artwork/light/system/system.svg#artwork-minor"></use>
                                                    <use class="fr-artwork-major" href="../../../dist/artwork/light/system/system.svg#artwork-major"></use>
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
...
<div class="fr-header__tools-links">
    <button aria-controls="fr-theme-modal" data-fr-opened="false" type="button" class="fr-icon-theme-fill fr-btn--icon-left fr-btn">
        Paramètres d'affichage
    </button>
</div>
```
...
<ul class="fr-footer__bottom-list">
    <li class="fr-footer__bottom-item">
        <button aria-controls="fr-theme-modal" data-fr-opened="false" type="button" class="fr-footer__bottom-link fr-btn--display fr-btn">
            Paramètres d'affichage
        </button>
    </li>
</ul>
...
**Important :** La gestion du thème ne fonctionne pas sur Internet Explorer 11 qui ne supporte pas les variables CSS.
...
### Activation de la gestion du thème
...
```javascript
// Pour le thème clair
dsfr(document.documentElement).scheme.scheme = 'light';

// Pour le thème sombre
dsfr(document.documentElement).scheme.scheme = 'dark';

// Pour le thème système
dsfr(document.documentElement).scheme.scheme = 'system';
```

**Attention :** La propriété `data-fr-theme` est injectée sur l'élément `<html>` à partir de la valeur du scheme, elle ne doit pas être modifiée directement. Elle prendra automatiquement la valeur `light` ou `dark` en fonction de la valeur du scheme, ou des préférences système de l'utilisateur.
